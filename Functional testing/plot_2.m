...
file_pennylane = fullfile(thisDir, 'grad_desc_log_noisy_pennylane.txt'); % Pennylane
file_my   = fullfile(thisDir, 'grad_desc_log_noisy.txt');       % MyJuliVQC
...
out_pdf = fullfile(thisDir, 'fig_grad_desc_compare_noisy.pdf');
