#!/bin/bash
#SBATCH --job-name=my_var_cir
#SBATCH --partition=long         # 可改：short / normal / long / gpu
...
# 运行 MyJuliVQC 的 var_circ benchmark
julia --project=../MyJuliVQC_env variational_circuit_test.jl
